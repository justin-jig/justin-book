...
export const ALLOWED_SEGMENTS_interface:string[] = ["ui","builder","front","module"] as const;


export const navigation = [
    {
        children: ALLOWED_SEGMENTS_interface.map(seg => (
            { path :`/interface/${seg}`, name: seg, key : seg, active: true}
        )),
    },
    // {
    //     children: [
